...
```
* Open https://github.com/sergei12nalivaiko/js-assignments and test the build icon. Now it will run all tests and update status once you push changes to github. Keep this icon green!
